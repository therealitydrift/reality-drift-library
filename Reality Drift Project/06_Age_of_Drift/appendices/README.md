...
Materials in this directory may include:

- Conceptual indexes and reference structures  
- Canonical glossaries and term definitions  
...
- Each appendix is maintained as a standalone PDF.
- Appendices are labeled alphabetically for reference.
- Files are designed to be read independently of the main manuscript where appropriate.
